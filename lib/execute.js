...
async function bumpScheduleCounters(schedule) {
  ...
  // Compute the next fire time, then shift it by a random 0..jitter_minutes so
  // posts don't land on predictable clock marks. Non-blocking — the delay lives
  // in next_run_at, not in a sleep.
